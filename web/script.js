...
document.addEventListener("click", (event) => {
  if (event.target.matches("#btn-delete")) {
    ...
    Swal.fire({
      ...
      confirmButtonColor: "#0ebec4",
      cancelButtonColor: "#d40606",
...
document.addEventListener("click", (event) => {
  if (event.target.matches("#btn-edit")) {
    ...
    const descriptionEdit =
      ...
      const DateEdit = article.children[0].children[0].textContent;
    ...
    data.forEach((task) => {
      ...
      <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
              ...
              <h6 class="card-text">${task.date}</h6>
              <div>
                  <button class="btn btn-outline-success" id="btn-edit">Edit</button>
                  <button type="" class="btn btn-outline-danger" id="btn-delete">Delete</button>
              </div>
          </div>
      </div>
  </article>
